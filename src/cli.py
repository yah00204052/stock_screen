...
def screen(tickers, min_cap, sector, ma_bullish, above_resistance, high_volume):
    """
    ...
    # Print table header
    click.echo(f"{'Ticker':<8} {'Name':<20} {'Sector':<15} {'Price':<10} {'Market Cap':<12} {'MA20>50':<8} {'Res':<8} {'Vol':<8}")
    click.echo("-" * 110)
    ...
    for result in results:
        ...
        click.echo(
            ...
            f"{ma_str:<8} {res_str:<8} {vol_str:<8}"
        )
